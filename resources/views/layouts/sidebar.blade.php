    ...
    <div class="sidebar-wrapper active">
      ...
      <div class="sidebar-menu">
        <ul class="menu">
          ...
          <li class="sidebar-item @if(Request::is('distribution')) active @endif">
          ...
          <li class="sidebar-item has-sub">
            <a href="#" class="sidebar-link">
              ...
              <span>Anggota Mitra</span>
            </a>
            <ul class="submenu">
              <li class="submenu-item">
                <a href="/anggota">Semua Anggota</a>
              </li>
              <li class="submenu-item">
                <a href="/anggota/add">Tambah Anggota</a>
              </li>
            </ul>
          </li>
          <li class="sidebar-item has-sub">
            ...
            <ul class="submenu">
              <li class="submenu-item">
                <a href="/komunitas">Semua Komunitas</a>
              </li>
              <li class="submenu-item">
                <a href="/komunitas/add">Tambah Komunitas</a>
              </li>
            </ul>
          </li>
          ...
          <li class="sidebar-item has-sub">
            ...
            <ul class="submenu">
              <li class="submenu-item">
                <a href="/ekspedisi">Semua Ekspedisi</a>
              </li>
              <li class="submenu-item">
                <a href="/ekspedisi/add">Tambah Ekspedisi</a>
              </li>
            </ul>
          </li>
          ...
          <li class="sidebar-item has-sub">
            ...
            <ul class="submenu">
              <li class="submenu-item">
                <a href="/post">Semua Postingan</a>
              </li>
              <li class="submenu-item">
                <a href="/post/add">Tambah Postingan</a>
              </li>
            </ul>
          </li>
